...
if ( len(sys.argv) != 8 ):
  print("  Usage: %s <home_path> <raw_video> <n_individuals> <fps> <block> <offset> <viewer [0/1]>" % sys.argv[0])
  print("\n    suggested values: \n")
  print("          block size = 15")
  print("              offset = 13\n")
  exit()
...
output_vidpath = home_path +'output/' + video_dir + "_" + video_str + '_tracked' + video_ext 
output_filepath = home_path + 'output/' + video_dir + "_" + video_str + '_tracked.dat'
if ( video_ext == ".avi" ):
  codec = 'DIVX' 
else:
  codec = 'mp4v'
