...
# Operate Archive object and extract useful information
def collect_all_sets(arc,ts,ns,tag,calc=False):
    d_dm = {}
    for t in ts:
        for n in ns:
            ...
            k = set_key(t,n)
            if calc:
                calculate_dw_thetaw_all_trials_in_set(arc,t,n)
...
# Access trials from within Archive object
